    ...
    >
      ...
      <div className="relative z-10 mx-auto w-[min(1380px,calc(100%-24px))] md:w-[min(1380px,calc(100%-40px))]">
        ...
        >
          ...
          <div className="relative">
            ...
            <motion.div 
              ...
              animate={{ x: `calc(-${startIndex * (100 / cardsPerPage)}% - ${startIndex * (24 / cardsPerPage)}px)` }}
            ...
            >
              {therapyCards.map((card) => (
                <div
                  ...
                  style={{ width: `calc(${100 / cardsPerPage}% - ${(cardsPerPage - 1) * 24 / cardsPerPage}px)` }}
                >
        ...
        <div className="mt-6 flex items-center justify-center gap-2.5">
            {Array.from({ length: therapyCards.length - cardsPerPage + 1 }).map((_, idx) => (
              <button
                key={`page-dot-${idx}`}
                type="button"
