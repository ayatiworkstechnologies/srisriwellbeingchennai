  ...
  return (
    <section className="py-24 bg-[#f5f2ec] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <h2 className="text-[#D4AF37] font-semibold tracking-widest uppercase text-sm mb-3">Why Choose Us</h2>
        ...
        >
          {features.map((feature, index) => (
            <motion.div 
              ...
              className="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-[#D4AF37]/10 hover:border-[#D4AF37]/30 relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-full bg-[#f5f2ec] flex items-center justify-center text-[#D4AF37] text-2xl mb-6 group-hover:scale-110 group-hover:bg-[#D4AF37] group-hover:text-white transition-all duration-300 shadow-sm">
                  {feature.icon}
                </div>
