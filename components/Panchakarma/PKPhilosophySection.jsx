...
const pillars = [
  { label: "Eliminates Root-Cause Toxins" },
  { label: "Boosts Immunity & Vitality" },
  { label: "Restores Digestive Balance" },
  { label: "Enhances Mental Clarity" },
];

const PillarIcon = () => (
  <div className="relative inline-flex items-center justify-center mr-3">
    <FaSeedling className="text-[28px] text-[#c79f31]" />
...
export default function PKPhilosophySection() {
  const [hoveredCard, setHoveredCard] = useState(null);
  const cards = [
    { image: "/images/ser-6.jpg", label: "Detoxification" },
    { image: "/images/ser-7.jpg", label: "Rejuvenation" },
  ];
