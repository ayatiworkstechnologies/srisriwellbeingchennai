      ...
      >
        ...
        <div className="relative w-full bg-[#f8f6f1] lg:w-1/2">
          <div className="relative h-56 w-full sm:h-64 lg:h-72">
            ...
            <h3 className="section-title absolute bottom-6 left-8 text-white font-primary">
              {therapy.title}
            </h3>
          </div>
          
          <div className="p-5 sm:p-6 lg:p-8">
            <div className="small-text mb-6 flex w-fit items-center gap-2 rounded-full bg-white px-4 py-1.5 text-[#c29a2f] uppercase tracking-widest shadow-sm">
              <FaClock />
              <span>{therapy.duration}</span>
            </div>

            <div className="mb-6">
              <h4 className="section-subtitle mb-2 text-[#1f1a17] uppercase tracking-widest">
                Overview
              </h4>
        ...
        <div className="flex w-full flex-col justify-center bg-white p-5 sm:p-6 lg:w-1/2 lg:p-10 xl:p-12">
          <div className="mb-8">
            <h4 className="section-title mb-2 text-[#1f1a17] font-primary">
              Book Your Session
            </h4>
