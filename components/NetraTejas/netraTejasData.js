...
export const overviewHighlights = [
  "Eye therapy for relief and nourishment",
  "Helps reduce discomfort from eye disorders",
  "Holistic support for visual wellbeing",
];
...
export const featuredDoctor = {
  name: "Dr. Tharkesh Dayalan",
  title: "MS (Ayu), Eye and ENT specialist",
  subtitle: "Sri Sri Netra Tejas, Sarjapur, Bangalore",
  description:
...
export const testimonials = [
  {
    name: "Patient Story",
    role: "Holistic Eye Care Visitor",
    quote:
      "The approach feels gentle and thoughtful. The combination of therapies and eye exercises gave me a sense of real care instead of just a quick consultation.",
  },
  {
    name: "Family Feedback",
    role: "Parent Consultation",
    quote:
      "The guidance was clear, practical, and easy to follow. It helped us better understand children's eye strain and screen-related discomfort.",
  },
  {
    name: "Wellness Feedback",
