...
export const defaultNadiCamps = [
  ...
  {
    id: 2,
    doctor: "Dr. Priya Narayanan",
    camp_date: "28/05/2026",
    location: "Coimbatore, Tamil Nadu",
    contact: "Sathish K (9876543210)",
    address: "No. 24, Wellness Avenue, RS Puram, Coimbatore",
    sort_order: 2,
    is_active: true,
  },
  {
    id: 3,
    doctor: "Dr. Meenakshi Raman",
    camp_date: "04/06/2026",
    location: "Madurai, Tamil Nadu",
    contact: "Bharathi S (9123456780)",
    address: "Temple Road Community Hall, KK Nagar, Madurai",
    sort_order: 3,
    is_active: true,
  },
];
...
export const defaultRelaxationTherapies = [
  {
    ...
    title: "Abhyanga",
    duration: "45 mins",
    short_description: "An Ayurvedic procedure involving warm medicated oil and gentle massage for relaxation.",
    details:
  ...
  },
  {
    ...
    title: "Shirodhara",
    duration: "45 mins",
    short_description: "A signature Ayurvedic therapy where warm oil is poured continuously over the forehead.",
    details:
